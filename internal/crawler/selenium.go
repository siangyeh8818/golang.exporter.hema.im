...
import (
	...
	tool "github.com/siangyeh8818/golang.exporter.hema.im/internal/tool"
...
func RunSelium() string {
	...
	err = w_b1.Get("https://hema.im/index.php/login")
	if err != nil {
	...
	webelement, _ := w_b1.FindElement(selenium.ByID, "mail")
	webelement.SendKeys(os.Getenv("ACCOUNT_EMAIL"))
	webelement2, _ := w_b1.FindElement(selenium.ByID, "pwd")
	webelement2.SendKeys(os.Getenv("ACCOUNT_PASSWORD"))
	time.Sleep(3 * time.Second)
	webelement3, _ := w_b1.FindElement(selenium.ByXPATH, "/html/body/div[2]/div[2]/form/div[4]/button")
	log.Println(webelement3.Text())
	webelement3.Click()

	time.Sleep(3 * time.Second)
	err = w_b1.Get("https://hema.im/index.php/home")
	if err != nil {
		fmt.Println("get page faild", err.Error())
		//return
	}
